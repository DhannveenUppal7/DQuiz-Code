...
function AssesGame({ quiz, quizPlayed, setQuizPlayed, qIndex, setQIndex }) {
    ...
    return (
        <div>
            ...
            {counter <= 30 && quiz.aOptionsD !== undefined ? <div>


                {quiz.image !== "" ? <img src={quiz.image} alt="quizImage" className='img-thumbnail quizImage' style={{ display: imgLoaded ? "block" : "none",  userSelect: "none" }} onLoad={()=>{setImgLoaded(true)}} /> : <></>}
